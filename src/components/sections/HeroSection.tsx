...
export default function HeroSection({
  ...
  return (
      ...
      <div className="mx-auto w-full max-w-container px-4 md:px-6 lg:px-8">
        ...
        >
          <h1 className="mx-auto max-w-4xl text-4xl font-extrabold leading-[1.08] text-neutral-900 sm:text-5xl md:text-6xl">
            {headline}
          </h1>
          <p className="mx-auto mt-6 max-w-2xl text-lg font-medium leading-relaxed text-neutral-600 md:text-xl">
            {subheadline}
          </p>
